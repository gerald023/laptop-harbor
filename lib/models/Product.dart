import 'package:aptech_project/models/Model.dart';
...
class Product extends Model {
  ...
  factory Product.fromMap(Map<String, dynamic> map, {required String id}) {
    if (map[SEARCH_TAGS_KEY] == null) {
      map[SEARCH_TAGS_KEY] = map[SEARCH_TAGS_KEY] = <String>[];
    }
    return Product(
      id,
      ...
      productType: EnumToString.fromString(ProductType.values, map[PRODUCT_TYPE_KEY]) ?? ProductType.Others,
      ...
      owner: map[OWNER_KEY],
      searchTags: map[SEARCH_TAGS_KEY].cast<String>(), favourite: map['favourite'] ?? false,
    );
  }
